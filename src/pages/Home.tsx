	...
	return (
		<div className="bg-white font-sans text-slate-900 antialiased">
			...
			<section className="relative overflow-hidden px-6 pb-0 pt-20 text-center sm:pt-28">
				...
				<div
					aria-hidden="true"
					className="animate-float absolute left-1/4 top-1/3 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-300 opacity-[0.10] blur-3xl"
				/>
				<div
					aria-hidden="true"
					className="animate-float-alt absolute right-1/4 top-2/3 h-56 w-56 rounded-full bg-violet-300 opacity-[0.08] blur-3xl"
				/>
				<div
					aria-hidden="true"
					className="animate-float-delay absolute left-2/3 top-1/4 h-40 w-40 rounded-full bg-sky-300 opacity-[0.09] blur-2xl"
				/>

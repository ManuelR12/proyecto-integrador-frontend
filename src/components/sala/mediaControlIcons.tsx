export const MicOnIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
...
export const MicOffIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
	<svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
export const CamOnIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
	<svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
export const CamOffIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
	<svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">

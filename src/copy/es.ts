...
export const auth = {
	...
	register: {
		...
		avatarUrlPlaceholder: "https://example.com/mi-foto.jpg",
		avatarHelper: "Pega una URL pública de tu foto de perfil.",
		emailLabel: "Correo",
		emailPlaceholder: "tu@correo.edu",
		passwordLabel: "Contraseña",
...
export const perfil = {
	...
	avatarLabel: "Avatar",
	avatarUrlLabel: "URL de la foto",
	avatarUrlPlaceholder: "https://example.com/mi-foto.jpg",
	avatarHelper: "Pega una URL pública de tu foto de perfil (Gravatar, LinkedIn, etc.)",
	nombresLabel: "Nombre",
	...
	deleteModal: {
		...
		countdown: (seconds: number) => `Puedes confirmar en ${seconds}s...`,
		countdownReady: "Ya puedes confirmar la eliminación",
